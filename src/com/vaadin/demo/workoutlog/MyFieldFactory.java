...
public class MyFieldFactory extends DefaultFieldFactory
{
		...
		if (f != null)
		{
			...
			if (propertyId.equals("kilometers"))
			{
				...
				f.addValidator(new Validator()
				{
					 ...
					 * 
					 */
					private static final long serialVersionUID = -7101381600364741491L;
	...
	private Field getTrainingTypeComboboxFor(Object itemId)
	{
		...
		if (cb == null)
		{
			...
			/*
			 * NewItemHandler so that new training types can be added fluently by typing it into combobox.
			 */
			cb2.setNewItemHandler(new NewItemHandler()
			{
				 ...
				 * 
				 */
				private static final long serialVersionUID = -5149963163349175938L;

				public void addNewItem(String newItemCaption)
				{
					Object identifier = trainingTypes.addItem();
					trainingTypes.getContainerProperty(identifier, "title").setValue(newItemCaption);
