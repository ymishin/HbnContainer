...
/**
 * This is a customized HbnContainer that adds an extra column to table (not in DB). Extra column will contain two
 * buttons that are hooked to run actions on that row.
 */
...
public class WorkoutListingWithSteroids extends HbnContainer
{
	...
	public class EntityItem extends HbnContainer.EntityItem
	{
		 ...
		 * 
		 */
		private static final long serialVersionUID = -8406353538409070097L;
		...
		public class ExtraActions extends HorizontalLayout implements Property
		{
			 ...
			 * 
			 */
			private static final long serialVersionUID = 7064419870715764194L;
			...
			public ExtraActions()
			{
				...
				b.addListener(new ClickListener()
				{
					 ...
					 * 
					 */
					private static final long serialVersionUID = -83304905882157539L;
				...
				del.addListener(new ClickListener()
				{
					 ...
					 * 
					 */
					private static final long serialVersionUID = -1200746809713233013L;
